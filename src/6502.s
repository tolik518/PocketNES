...
@----------------------------------------------------------------------------
_0B:@   ANC #$nn   - AND and then copy bit 7 to carry
@----------------------------------------------------------------------------
	doIMM
	opAND
	tst m6502_a,#0x80000000
	orrne cycles,cycles,#CYC_C
	biceq cycles,cycles,#CYC_C
	fetch 2
@----------------------------------------------------------------------------
_0D:@   ORA $nnnn
@----------------------------------------------------------------------------
...
@----------------------------------------------------------------------------
_87:@	SAX nn		;SAX nn    STA+STX  [nn]=A AND X
@----------------------------------------------------------------------------
	doZ
...
@----------------------------------------------------------------------------
	...
	fetch_c 2
@----------------------------------------------------------------------------
_6B:@   ARR #$nn - AND then ROR ("N and Z are normal, but C is bit 6 and V is bit 6 xor bit 5." - probably don't need to do V)
@----------------------------------------------------------------------------
	doIMM
	opAND
	movs cycles,cycles,lsr#1		@get C
...
op_table:
	...
	.word _20,_21,_xx,_23,_24,_25,_26,_27,_28,_29,_2A,_xx,_2C,_2D,_2E,_2F
	.word _30,_31,_xx,_33,_x4,_35,_36,_37,_38,_39,_EA,_3B,_xC,_3D,_3E,_3B
